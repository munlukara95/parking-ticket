...
@DisplayName("Tests for JeepVehicleParkingService Unit Test")
public class JeepVehicleParkingServiceUnitTest {
    JeepVehicleParkingService jeepVehicleParkingService;
    ...
    @BeforeEach
    void setUp(){
        jeepVehicleParkingService = new JeepVehicleParkingService(stampedLock, slotMapper);
    ...
    void tearDown(){
        ...
        jeepVehicleParkingService = null;
    }
    ...
    void givenValidVehicle_whenMultiRequestIncoming_thenSucceed() throws InterruptedException{
        ...
        for(int i = 0; i < THREAD_NUMBER; i++) {
            executorService.execute(() -> {
                Vehicle vehicle = MockDataUtil.createMockVehicleByVehicleTypeWithoutOccupiedNumberOfSlots(VehicleType.JEEP);
                jeepVehicleParkingService.parkingVehicle(vehicle);
