...
@DisplayName("Tests for TruckVehicleParkingService Unit Test")
public class TruckVehicleParkingServiceUnitTest {
    TruckVehicleParkingService truckVehicleParkingService;
    ...
    @BeforeEach
    void setUp(){
        truckVehicleParkingService = new TruckVehicleParkingService(stampedLock, slotMapper);
    ...
    void tearDown(){
        ...
        truckVehicleParkingService = null;
    }
    ...
    void givenValidVehicle_whenMultiRequestIncoming_thenSucceed() throws InterruptedException{
        ...
        for(int i = 0; i < THREAD_NUMBER; i++) {
            executorService.execute(() -> {
                Vehicle vehicle = MockDataUtil.createMockVehicleByVehicleTypeWithoutOccupiedNumberOfSlots(VehicleType.TRUCK);
                truckVehicleParkingService.parkingVehicle(vehicle);
